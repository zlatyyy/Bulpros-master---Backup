@smokeTestUC
Feature: Add product to cart and update cart
...
Given the user selects "<number>" from "<product>"
When user logs with his "<username>" and "<password>"
When the user add selected products to cart
Then the "<responseCode>" is ok
Then do checkout

Examples:
|number   |product   	|username											|password	 						|responseCode| 
|1	 	  |037			|userName=automationpass@bulpros.com@bulpros.com	|password=qwertyuiop1			|DWT-ESHP-ERR-002|
|1        |71 			|userName=automationnon@bulpros.com   				|password=qwertyuiop1      		|DWT-ESHP-ERR-003|
|500	  |37			|userName=automationpass@bulpros.com				|password=qwertyuiop1	  		|DWT-ESHP-ERR-006|
|1 	  	  |37			|userName=...@bulpros.com							|password=qwertyuiop1  			|DWT-ESHP-ERR-001|
|1	 	  |37			|userName=automationpass@bulpros.com				|password=qwertyuiop1  			|DWT-ESHP-SCS-001|
